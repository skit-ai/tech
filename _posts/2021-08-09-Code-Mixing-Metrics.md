...
- [Span Entropy](https://www.isca-speech.org/archive/Interspeech_2017/pdfs/1429.PDF) (SE) : An information theoretic measure of the language span distribution i.e. the number of bits needed to describe the probability distribution.
...
- [CM-WER](https://www.cse.iitb.ac.in/~pjyothi/files/IS19.pdf) : If there are M words on both sides of switch points across all reference transcriptions and N edits in the ASR hypotheses corresponding to words surrounding the switch points in the references, then CM-WER = N/M . This metric provides an estimate of how accurately the system predicts words at switch points.
